...
export default function LogOut() {
    return (
        <div className="loading-banner  dark:loading-dark dark:bg-card darK:bg-background  dark:text-foreground fixed top-0 left-0  z-[8888]  bg-black bg-opacity-50 text-white text-xl">
            <div className="flex min-h-full justify-center items-center m-0 w-full">
                <div className="max-w-md w-full text-black shadow-md text-center h-fit py-4 px-4 dark:bg-card dark:text-foreground bg-white flex flex-col">
                    <div className="max-w-[1600px] w-[90%] mx-auto block">
                        ...
                        <h1 className=" leading-[1.28571429em] font-[900] text-[#4f4f47] dark:text-foreground text-[2.5rem]">See you again soon</h1>
