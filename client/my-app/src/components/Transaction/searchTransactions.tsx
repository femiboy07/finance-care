...
export default function SearchTransactions({ clearFilter }: { clearFilter: () => void }) {
  ...
  return (
    <div className="search-container relative font-custom font-normal self-start shadow-xl sm:[450]:w-full lg:w-64 min-h-12 p-2 bg-white outline-gray-400 border-gray-500 rounded-md flex-shrink-0   ">
      <input
        type="text"
        autoComplete="off"
        value={search}
        ...
        className="absolute inset-0  w-full  border focus-within:border-orange-400 placeholder:text-orange-400 placeholder:font-semibold outline-none border-slate-100  h-full pl-8      bg-white "
      />
